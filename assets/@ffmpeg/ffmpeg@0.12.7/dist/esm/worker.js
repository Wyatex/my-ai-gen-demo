...
self.onmessage = async ({ data: { id, type, data: _data }, }) => {
    self.postMessage({ id, type: FFMessageType.LOG, data: { message: `[worker.js] onmessage received type: ${type}` } });
    const trans = [];
    let data;
    try {
        ...
        switch (type) {
            case FFMessageType.LOAD:
                ...
                self.postMessage({ id, type: FFMessageType.LOG, data: { message: `[worker.js] load() finished successfully!` } });
                break;
